...
if(!function_exists('optionsframework_options')) {
	...
	function optionsframework_options() {
		...
		$options['google_mixed_3'] = array( 'name' => theme_locals('body_text_name'),
							...
							'id' => 'google_mixed_3',
							'std' => array( 'size' => '16px', 'lineheight' => '24px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#8d8880'),
							'type' => 'typography',
							'options' => array(
		...
		$options['h1_heading'] = array( 'name' => theme_locals('h1_name'),
							...
							'id' => 'h1_heading',
							'std' => array( 'size' => '28px', 'lineheight' => '34px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#2f2f2f'),
							'type' => 'typography',
							'options' => array(
									'faces' => $typography_mixed_fonts )
							);
		...
		$options['h2_heading'] = array( 'name' => theme_locals('h2_name'),
							...
							'id' => 'h2_heading',
							'std' => array( 'size' => '22px', 'lineheight' => '22px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#2f2f2f'),
							'type' => 'typography',
							'options' => array(
									'faces' => $typography_mixed_fonts )
							);
		...
		$options['h3_heading'] = array( 'name' => theme_locals('h3_name'),
							...
							'id' => 'h3_heading',
							'std' => array( 'size' => '18px', 'lineheight' => '18px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#2f2f2f'),
							'type' => 'typography',
							'options' => array(
									'faces' => $typography_mixed_fonts )
							);
		...
		$options['h4_heading'] = array( 'name' => theme_locals('h4_name'),
							...
							'id' => 'h4_heading',
							'std' => array( 'size' => '14px', 'lineheight' => '18px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#2f2f2f'),
							'type' => 'typography',
							'options' => array(
									'faces' => $typography_mixed_fonts )
							);
		...
		$options['h5_heading'] = array( 'name' => theme_locals('h5_name'),
							...
							'id' => 'h5_heading',
							'std' => array( 'size' => '12px', 'lineheight' => '18px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#2f2f2f'),
							'type' => 'typography',
							'options' => array(
									'faces' => $typography_mixed_fonts )
							);
		...
		$options[] = array( 'name' => theme_locals('logo_t_name'),
							...
							'id' => 'logo_typography',
							'std' => array( 'size' => '30px', 'lineheight' => '36px', 'face' => 'Montserrat', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'),
							'type' => 'typography',
							'options' => array(
									'faces' => $typography_mixed_fonts )
							);
		...
		$options[] = array( 'name' => theme_locals('menu_t_name'),
							...
							'id' => 'menu_typography',
							'std' => array( 'size' => '15px', 'lineheight' => '18px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ebd5b0'),
							'type' => 'typography',
							'options' => array(
									'faces' => $typography_mixed_fonts )
							);
		...
		$options[] = array( 'name' => theme_locals("footer_menu_typography_name"),
							...
							'std' => array( 'size' => '14px', 'lineheight' => '18px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ebd5b0'),
							'type' => 'typography',
							'options' => array(
									'faces' => $typography_mixed_fonts )
							);
