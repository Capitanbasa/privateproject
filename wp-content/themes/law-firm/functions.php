...
add_action( 'after_setup_theme', 'law_firm_register_menus' );
add_action( 'wp_enqueue_scripts', 'law_firm_enqueue_scripts_styles' );
add_action( 'tgmpa_register', 'law_firm_register_plugins' );
add_action( 'wp_enqueue_scripts', 'law_firm_load_fonts' );

add_action( 'admin_enqueue_scripts', 'law_firm_load_admin_style' );

add_filter( 'bt_bb_color_scheme_arr', 'law_firm_color_schemes' );

add_filter( 'body_class', 'law_firm_body_class' );
 ...
 */
if ( ! function_exists( 'law_firm_register_menus' ) ) {
	function law_firm_register_menus() {
		register_nav_menus( array (
			'primary' => esc_html__( 'Primary Menu', 'law-firm' ),
			'footer'  => esc_html__( 'Footer Menu', 'law-firm' )
		));
	}
}
 ...
 */
if ( ! function_exists( 'law_firm_enqueue_scripts_styles' ) ) {
	function law_firm_enqueue_scripts_styles() {
		...
		// custom theme css
		wp_enqueue_style( 'law-firm-style', get_parent_theme_file_uri( 'style.css' ), array(), false, 'screen' );
		wp_enqueue_style( 'law-firm-print', get_parent_theme_file_uri( 'print.css' ), array(), false, 'print' );
		...
		wp_enqueue_script( 'law-firm-modernizr', get_parent_theme_file_uri( 'framework/js/modernizr.custom.js' ), array( 'jquery' ), '', false );

		// custom theme js
		wp_enqueue_script( 'law-firm-header', get_parent_theme_file_uri( 'framework/js/header.misc.js' ), array( 'jquery' ), '', true );
		wp_enqueue_script( 'law-firm-misc', get_parent_theme_file_uri( 'framework/js/misc.js' ), array( 'jquery' ), '', true );
		...
		if ( file_exists( get_parent_theme_file_path( 'css-override.php' ) ) && $boldthemes_add_override_css ) {
			...
			wp_add_inline_style( 'law-firm-style', $css_override );
		}
		
		if ( file_exists( get_parent_theme_file_path( 'icons.php' ) ) ) {
			require_once( get_parent_theme_file_path( 'icons.php' ) );
			wp_add_inline_style( 'law-firm-style', $icons );
		}

		if ( boldthemes_get_option( 'custom_js' ) != '' ) {
			wp_add_inline_script( 'law-firm-modernizr', boldthemes_get_option( 'custom_js' ) );
		}	
 ...
 */
if ( ! function_exists( 'law_firm_register_plugins' ) ) {
	function law_firm_register_plugins() {

		$plugins = array(
	 
			array(
				'name'               => esc_html__( 'Law Firm', 'law-firm' ), // The plugin name.
				'slug'               => 'law-firm', // The plugin slug (typically the folder name).
				'source'             => get_parent_theme_file_path( 'plugins/law-firm.zip' ), // The plugin source.
			...
			array(
				'name'               => esc_html__( 'Cost Calculator', 'law-firm' ), // The plugin name.
			...
			array(
				'name'               => esc_html__( 'Bold Builder', 'law-firm' ), // The plugin name.
			...
			array(
				'name'               => esc_html__( 'BoldThemes WordPress Importer', 'law-firm' ), // The plugin name.
			...
			array(
				'name'               => esc_html__( 'Meta Box', 'law-firm' ), // The plugin name.
			...
			array(
				'name'               => esc_html__( 'Contact Form 7', 'law-firm' ), // The plugin name.
			...
			array(
				'name'               => esc_html__( 'WooSidebars', 'law-firm' ), // The plugin name.
		...
		$config = array(
			...
			'strings'      => array(
				'page_title'                      => esc_html__( 'Install Required Plugins', 'law-firm' ),
				'menu_title'                      => esc_html__( 'Install Plugins', 'law-firm' ),
				'installing'                      => esc_html__( 'Installing Plugin: %s', 'law-firm' ), // %s = plugin name.
				'oops'                            => esc_html__( 'Something went wrong with the plugin API.', 'law-firm' ),
				'notice_can_install_required'     => _n_noop( 'This theme requires the following plugin: %1$s.', 'This theme requires the following plugins: %1$s.', 'law-firm' ), // %1$s = plugin name(s).
				'notice_can_install_recommended'  => _n_noop( 'This theme recommends the following plugin: %1$s.', 'This theme recommends the following plugins: %1$s.', 'law-firm' ), // %1$s = plugin name(s).
				'notice_cannot_install'           => _n_noop( 'Sorry, but you do not have the correct permissions to install the %s plugin. Contact the administrator of this site for help on getting the plugin installed.', 'Sorry, but you do not have the correct permissions to install the %s plugins. Contact the administrator of this site for help on getting the plugins installed.', 'law-firm' ), // %1$s = plugin name(s).
				'notice_can_activate_required'    => _n_noop( 'The following required plugin is currently inactive: %1$s.', 'The following required plugins are currently inactive: %1$s.', 'law-firm' ), // %1$s = plugin name(s).
				'notice_can_activate_recommended' => _n_noop( 'The following recommended plugin is currently inactive: %1$s.', 'The following recommended plugins are currently inactive: %1$s.', 'law-firm' ), // %1$s = plugin name(s).
				'notice_cannot_activate'          => _n_noop( 'Sorry, but you do not have the correct permissions to activate the %s plugin. Contact the administrator of this site for help on getting the plugin activated.', 'Sorry, but you do not have the correct permissions to activate the %s plugins. Contact the administrator of this site for help on getting the plugins activated.', 'law-firm' ), // %1$s = plugin name(s).
				'notice_ask_to_update'            => _n_noop( 'The following plugin needs to be updated to its latest version to ensure maximum compatibility with this theme: %1$s.', 'The following plugins need to be updated to their latest version to ensure maximum compatibility with this theme: %1$s.', 'law-firm' ), // %1$s = plugin name(s).
				'notice_cannot_update'            => _n_noop( 'Sorry, but you do not have the correct permissions to update the %s plugin. Contact the administrator of this site for help on getting the plugin updated.', 'Sorry, but you do not have the correct permissions to update the %s plugins. Contact the administrator of this site for help on getting the plugins updated.', 'law-firm' ), // %1$s = plugin name(s).
				'install_link'                    => _n_noop( 'Begin installing plugin', 'Begin installing plugins', 'law-firm' ),
				'activate_link'                   => _n_noop( 'Begin activating plugin', 'Begin activating plugins', 'law-firm' ),
				'return'                          => esc_html__( 'Return to Required Plugins Installer', 'law-firm' ),
				'plugin_activated'                => esc_html__( 'Plugin activated successfully.', 'law-firm' ),
				'complete'                        => esc_html__( 'All plugins installed and activated successfully. %s', 'law-firm' ), // %s = dashboard link.
 ...
 */
if ( ! function_exists( 'law_firm_load_fonts' ) ) {
	function law_firm_load_fonts() {
		$body_font = urldecode( boldthemes_get_option( 'body_font' ) );
		$heading_font = urldecode( boldthemes_get_option( 'heading_font' ) );
		$menu_font = urldecode( boldthemes_get_option( 'menu_font' ) );
		$heading_subtitle_font = urldecode( boldthemes_get_option( 'heading_subtitle_font' ) );
		...
		if ( $body_font != '' ) {
			...
			$body_font_state = _x( 'on', 'Lato font: on or off', 'law-firm' );
		...
		if ( $heading_font != '' ) {
			...
			$heading_font_state = _x( 'on', 'Lato font: on or off', 'law-firm' );
		...
		if ( $menu_font != '' ) {
			...
			$menu_font_state = _x( 'on', 'Lato font: on or off', 'law-firm' );
		...
		if ( $heading_subtitle_font != '' ) {
			...
			$heading_subtitle_font_state = _x( 'on', 'Lato font: on or off', 'law-firm' );
		...
		if ( $heading_supertitle_font != '' ) {
			...
			$heading_supertitle_font_state = _x( 'on', 'Lato font: on or off', 'law-firm' );
...
if ( ! function_exists( 'law_firm_load_admin_style' ) ) {
	function law_firm_load_admin_style() {
		wp_enqueue_style( 'law-firm-style', get_parent_theme_file_uri( 'admin-style.css' ) );
		require_once( get_parent_theme_file_path( 'admin-style.php' ) );
		wp_add_inline_style( 'law-firm-style', $admin_style );
	}
}
 ...
 * @return string 
 */
if ( ! function_exists( 'law_firm_body_class' ) ) {
	function law_firm_body_class( $extra_class ) {
