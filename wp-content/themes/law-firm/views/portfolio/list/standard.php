		...
		echo '<div class="port">';
			echo '<div class="btArticleContentHolder">';
				...
				echo '<div class="btArticleShareEtc">';
					...
					if ( $share_html != '' ) echo '<div class="btShareColumn">' . wp_kses_post( $share_html ) . '</div><!-- /btTags -->';
					echo '<div class="btReadMoreColumn">';
						$continue_icon = ! is_rtl() ? 'fa_f061' : 'fa_f060';
						$continue_icon_position = ! is_rtl() ?  'right' : 'left';
						echo boldthemes_get_button_html( array ( 'icon' => $continue_icon, 'url' => get_permalink(), 'text' => esc_html__( 'CONTINUE READING', 'law-firm' ), 'style' => 'outline', 'size' => 'small', 'icon_position' => $continue_icon_position ) );
					echo '</div><!-- /btTags -->';
