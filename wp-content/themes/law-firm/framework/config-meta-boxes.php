...
boldthemes_add_meta_box( array( 'id' => 'page', 'title' => esc_html__( 'Settings', 'law-firm' ), 'post_type' => 'page', 'autosave' => true ) );
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'page',
		'field_id' => 'menu_name',
		'name'     => esc_html__( 'Custom Primary Menu Name', 'law-firm' ),
		'type'     => 'text'
	)
);
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'page',
		'field_id' => 'override',
		'name'     => esc_html__( 'Override Global Settings', 'law-firm' ),
		'type'     => 'boldthemestext',
		'clone'    => true
	)
);
...
boldthemes_add_meta_box( array( 'id' => 'post', 'title' => esc_html__( 'Settings', 'law-firm' ), 'post_type' => 'post', 'autosave' => true ) );
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'post',
		'field_id' => 'description',
		'name'     => esc_html__( 'Meta Description', 'law-firm' ),
		'type'     => 'textarea'
	)
);
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'post',
		'field_id' => 'images',
		'name'     => esc_html__( 'Images', 'law-firm' ),
		'type'     => 'image_advanced'
	)
);
boldthemes_add_mb_field( 
	array(
		...
		'name'     => esc_html__( 'Grid Gallery', 'law-firm' ),
		'type'     => 'checkbox'
	)
);
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'post',
		'field_id' => 'video',
		'name'     => esc_html__( 'Video', 'law-firm' ),
		'type'     => 'text'
	)
);
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'post',
		'field_id' => 'audio',
		'name'     => esc_html__( 'Audio', 'law-firm' ),
		'type'     => 'text'
	)
);
boldthemes_add_mb_field( 
...
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'post',
		'field_id' => 'link_url',
		'name'     => esc_html__( 'Link URL', 'law-firm' ),
		'type'     => 'text'
	)
);
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'post',
		'field_id' => 'quote',
		'name'     => esc_html__( 'Quote', 'law-firm' ),
		'type'     => 'text'
	)
);
boldthemes_add_mb_field( 
	array(
		...
		'name'     => esc_html__( 'Quote Author', 'law-firm' ),
		'type'     => 'text'
	)
);
...
boldthemes_add_meta_box( array( 'id' => 'portfolio', 'title' => esc_html__( 'Settings', 'law-firm' ), 'post_type' => 'portfolio', 'autosave' => true ) );
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'portfolio',
		'field_id' => 'description',
...
boldthemes_add_mb_field( 
	array(
		...
		'name'     => esc_html__( 'Custom Fields', 'law-firm' ),
...
boldthemes_add_meta_box( array( 'id' => 'product', 'title' => esc_html__( 'Settings', 'law-firm' ), 'post_type' => 'product', 'autosave' => true ) );
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'product',
		'field_id' => 'override',
